...
export default function Proyect({ proyectName, children, imageSRC, githubLink }){
    return <div className="flex items-center bg-whiteTxt w-[1560px] h-[480px] rounded-[50px] px-[60px] py-[58px] mb-[94px]">
        ...
        <div className="max-w-[770px] ml-[63px] relative bottom-[30px] flex flex-col justify-center h-[100%]">
            ...
            <div className="flex mt-[22px]">
                ...
                <a href="" className="rounded-[10px] px-[16px] py-[11px] w-[170px] h-[36px] bg-blackbg  text-whiteTxt flex justify-center items-center"><p className="mr-[7px]">Link webpage</p> <ion-icon name="document"></ion-icon></a>
            </div>
        </div>
    </ div>
}